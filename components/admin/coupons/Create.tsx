...
export default function Create({ setCoupons }: CreateProps) {
  ...
  const handleStartDate = (newValue: string | Date | null) => {
    newValue && setStartDate(newValue as Date);
  };

  const handleEndDate = (newValue: string | Date | null) => {
    newValue && setEndDate(newValue as Date);
  };
