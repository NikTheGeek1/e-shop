  ...
  return (
    <React.Fragment>
      <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
        ...
        <TableCell align="right">{row.couponApplied.coupon || "-"}</TableCell>
        <TableCell align="right">
          <b>{row.total}$</b>
        </TableCell>
      </TableRow>
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box sx={{ margin: 1 }}>
              ...
              <Table size="small" aria-label="purchases">
                ...
                <TableBody>
                  <TableRow key={(row.user as IUser)._id! as string}>
                    <TableCell component="th" scope="row">
                      <img
                        src={(row.user as IUser).image}
                        className={styles.table__img}
                        alt=""
                      />
                    </TableCell>
                    <TableCell>{(row.user as IUser).name}</TableCell>
                    <TableCell align="left">
                      {(row.user as IUser).email}
                    </TableCell>
                    <TableCell align="right">
