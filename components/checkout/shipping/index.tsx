...
import { AddressType, IUser } from "../../../models/User";
    ...
    <div className={styles.shipping}>
      ...
      <div className={styles.addresses}>
        {addresses.map((address, idx) => {
          return (
            <div style={{ position: "relative" }} key={idx + address._id!}>
              <div
              ...
              >
                <div className={styles.address__side}>
                  <img src={profile ? user.image : user.image} alt="" />
                </div>
      ...
      <button className={styles.hide_show} onClick={() => setVisible(oldState =>  !oldState)}>
        {visible ? (
          <span>
